...
docker run -d --name simplecqrsapi-itest -e "DOTNET_USE_POLLING_FILE_WATCHER=1" -e ConnectionStrings:EventStoreConnection=%EVENTSTORE_CONNECTION%  -p %InventoryLogicServicePort%:80 simplecqrsapi:latest
...
REM docker stop simplecqrsapi-itest
