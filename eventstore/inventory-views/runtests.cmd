...
docker run -d --name simplecqrs-views-itest -e "DOTNET_USE_POLLING_FILE_WATCHER=1" -e ConnectionStrings:EventStoreConnection=%EVENTSTORE_CONNECTION%  -p %InventoryViewsServicePort%:8080 simplecqrsviews:latest
